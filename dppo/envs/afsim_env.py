...
class AFSIMIslandEnv(object):
    ...
    def reward_movement_scale(self):
        return float(self.reward_target_priority_config.get("movement_reward_scale", 1.0))
    ...
    def apply_attack_aircraft_action(self, group_id, aircraft_name, action_id, _force_in_range=False):
        ...
        if service_phase in ("returning", "rearming") and action.get("name") == "HOLD":
            return True
    ...
    def _build_attack_action_mask(self, platform, group, values):
        ...
        for _, spec in specs:
            ...
            if not platform.alive:
                ...
                # Return remains a formation-level decision made by the leader.
                available = 1.0 if is_leader else 0.0
