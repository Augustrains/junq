...
class TaskTrajectoryBuffer:
    ...
    def discard_episode(self):
        """Discard all rows from the current technical-failure episode.

        Keep the current policy version so the next clean scenario remains
        labelled with the learner version that produced its actions.
        """
