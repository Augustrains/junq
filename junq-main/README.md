...
Run the offline interface smoke tests without Warlock:

```powershell
python D:\junq\dppo\rl_interface_smoke_test.py
python D:\junq\dppo\hierarchical_rollout_smoke_test.py
```
...
and global state. Run its smoke test with:

```powershell
python D:\junq\dppo\train\rollout_collector_smoke_test.py
```
...
```powershell
python D:\junq\dppo\train\ppo_networks_smoke_test.py
python D:\junq\dppo\train\mappo_trainer_smoke_test.py
python D:\junq\dppo\train\collector_mappo_update_smoke_test.py
python D:\junq\dppo\train\commander_ppo_trainer_smoke_test.py
```
