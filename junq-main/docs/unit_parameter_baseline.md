...
Applied to `island_assault_min.txt` and verified with `rl_interface_live_test.py` plus `afsim_ppo_bridge.py`.
...
- `python D:\junq\dppo\rl_interface_live_test.py`: passed.
